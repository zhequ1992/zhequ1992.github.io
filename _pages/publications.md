...
3. <ins>Title:</ins> Personalized Federated Learning with Domain Generalization,\
   <ins>Authors:</ins> Yuan Liu\#, **Zhe Qu\***, Shu Wang, Chengchao Shen, Yixiong Liang, and Jianxin Wang.
4. <ins>Title:</ins> Adapting Microservice Deployment at Network Edge via Distributed Graph Reinforcement Learning,\
   <ins>Authors:</ins> Lixing Chen, Zhongqi Miao, Yang Bai, Pan Zhou, **Zhe Qu**, Jianhua Li, and Cailian Chen.

2024
=====
1. <ins>Title:</ins> MARE: Multi-Aspect Rationale Extractor on Unsupervised Rationale Extraction,\
...
2. <ins>Title:</ins> Stability and Generalization for Stochastic Recursive Momentum-based Algorithms for (Strongly)-Convex One to $K$-Level Stochastic Optimizations,\
...
3. <ins>Title:</ins> FedGCA: Global Consistent Augmentation based Single-Source Federated Domain Generalization,\
...
4. <ins>Title:</ins> FedMMR: Multi-Modal Federated Learning via Missing Modality Reconstruction,\
...
5. <ins>Title:</ins> Bandwidth Allocation for Federated Learning under Wireless Providers with Cost Constraints,\
...
6. <ins>Title:</ins> Guessing on Dominant Paths: Understanding the Limitation of Wireless Authentication Using Channel State Information,\
...
7. <ins>Title:</ins> Divide, Conquer, and Coalesce: Meta Parallel Graph Neural Network for IoT Intrusion Detection at Scale,\
...
8. <ins>Title:</ins> On Adaptive Edge Microservice Placement: A Reinforcement Learning Approach Endowed with Graph Comprehension,\
...
9. <ins>Title:</ins> Segmenting Ischemic Penumbra and Infarct Core Simultaneously on Non-Contrast CT of Patients with Acute Ischemic Stroke Using A Novel Convolutional Neural Network,\
...
10. <ins>Title:</ins> Parrot-Trained Adversarial Examples: Pushing the Practicality of Black-Box Audio Attacks against Speaker Recognition Models,\
...
11. <ins>Title:</ins> What Makes Good Collaborative Views? Contrastive Mutual Information Maximization for Multi-Agent Perception,\
...
12. <ins>Title:</ins> Faster Stochastic Variance Reduction Methods for Compositional MiniMax Optimization,\
...
13. <ins>Title:</ins> FedLGA: Towards System-Heterogeneity of Federated Learning via Local Gradient Approximation,\
...
2. <ins>Title:</ins> On the Convergence of Multi-Server Federated Learning with Overlapping Area,\
...
3. <ins>Title:</ins> Modeling Global Distribution for Federated Learning with Label Distribution Skew,\
...
4. <ins>Title:</ins> Data-Driven Next-Generation Wireless Networking: Embracing AI for Performance and Security,\
...
5. <ins>Title:</ins> How To Prevent the Poor Performance Clients for Personalized Federated Learning?\
...
6. <ins>Title:</ins> LoMar: A Local Defense Against Poisoning Attack on Federated Learning,\
...
7. <ins>Title:</ins> Context-Aware Online Client Selection for Hierarchical Federated Learning,\
...
8. <ins>Title:</ins> Stragglers Are Not Disaster: A Hybrid Federated Learning Algorithm with Delayed Gradients,\
   <ins>Authors:</ins> Xingyu Li, **Zhe Qu**, Bo Tang, and Zhuo Lu,\
...
9. <ins>Title:</ins> Perception-Aware Attack: Creating Adversarial Music via Reverse-Engineering Human Perception,\
   <ins>Authors:</ins> Rui Duan, **Zhe Qu**, Shangqing Zhao, Leah Ding, Yao Liu, and Zhuo Lu,\
...
10. <ins>Title:</ins> Generalized Federated Learning via Sharpness Aware Minimization,\
...
11. <ins>Title:</ins> How to Test the Randomness From the Wireless Channel for Security?\
...
12. <ins>Title:</ins> ProTO: Proactive Topology Obfuscation Against Adversarial Network Topology Inference,\
...
13. <ins>Title:</ins> Comb Decoding towards Collision-Free WiFi,\
...
14. <ins>Title:</ins> Security of HPC systems: From a log-analyzing perspective,\
